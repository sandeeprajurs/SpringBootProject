package com.todo.webapp.restfulwebservices.controller;
...
import com.todo.webapp.restfulwebservices.todo.Todo;
import com.todo.webapp.restfulwebservices.todo.TodoHardcodedService;
...
public class ToDoResources {
	...
	public Todo getTodo(@PathVariable String username, @PathVariable long id) {
		return todoService.findToById(id);
	}
